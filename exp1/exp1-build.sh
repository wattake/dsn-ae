...
for syscall in "${syscalls[@]}"; do
    sed -i "s/CONFIG_UK_DEFNAME=".*"/CONFIG_UK_DEFNAME=\"uk-${syscall}\"/g" .config
    sed -i "s/CONFIG_UK_NAME=".*"/CONFIG_UK_NAME=\"uk-${syscall}\"/g" .config
...
for syscall in "${syscalls[@]}"; do
    sed -i "s/CONFIG_UK_DEFNAME=".*"/CONFIG_UK_DEFNAME=\"vp-${syscall}\"/g" .config
    sed -i "s/CONFIG_UK_NAME=".*"/CONFIG_UK_NAME=\"vp-${syscall}\"/g" .config
    sed -i "s/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^}.*/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/g" .config
    make
    sed -i "s/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^} is not set/g" .config
done
...
for syscall in "${syscalls[@]}"; do
    sed -i "s/CONFIG_UK_DEFNAME=".*"/CONFIG_UK_DEFNAME=\"nosals-${syscall}\"/g" .config
    sed -i "s/CONFIG_UK_NAME=".*"/CONFIG_UK_NAME=\"nosals-${syscall}\"/g" .config
    sed -i "s/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^}.*/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/g" .config
    make
    sed -i "s/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^} is not set/g" .config
done
...
for syscall in "${syscalls[@]}"; do
    sed -i "s/CONFIG_UK_DEFNAME=".*"/CONFIG_UK_DEFNAME=\"das-${syscall}\"/g" .config
    sed -i "s/CONFIG_UK_NAME=".*"/CONFIG_UK_NAME=\"das-${syscall}\"/g" .config
    sed -i "s/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^}.*/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/g" .config
    make
    sed -i "s/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^} is not set/g" .config
done
...
for syscall in "${syscalls[@]}"; do
    sed -i "s/CONFIG_UK_DEFNAME=".*"/CONFIG_UK_DEFNAME=\"fsm-${syscall}\"/g" .config
    sed -i "s/CONFIG_UK_NAME=".*"/CONFIG_UK_NAME=\"fsm-${syscall}\"/g" .config
    sed -i "s/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^}.*/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/g" .config
    make
    sed -i "s/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^} is not set/g" .config
done
...
for syscall in "${syscalls[@]}"; do
    sed -i "s/CONFIG_UK_DEFNAME=".*"/CONFIG_UK_DEFNAME=\"netm-${syscall}\"/g" .config
    sed -i "s/CONFIG_UK_NAME=".*"/CONFIG_UK_NAME=\"netm-${syscall}\"/g" .config
    sed -i "s/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^}.*/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/g" .config
    make
    sed -i "s/CONFIG_LIBMRTIME_SYSCALL_${syscall^^}=y/# CONFIG_LIBMRTIME_SYSCALL_${syscall^^} is not set/g" .config
done
